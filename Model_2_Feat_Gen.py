...
if __name__ == "__main__":
    ...
    #print(os.listdir('../Dropbox/Kaggle_AllState/'))
    #print(os.getcwd())
    print('\nStarted')
    ...
    train.to_pickle(directory + 'train_model_2.pkl')
    test.to_pickle(directory + 'test_model_2.pkl')
    #feather.write_dataframe(train, directory + 'train_model_2.feather' )
    #feather.write_dataframe(test, directory + 'test_model_2.feather' )
"""
